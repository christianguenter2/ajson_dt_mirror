INTERFACE zif_dt_ajson
  ...
  DATA mt_json_tree TYPE zif_dt_ajson_types=>ty_nodes_ts READ-ONLY.
  ...
  METHODS get_node_type
    IMPORTING
      iv_path TYPE string
    RETURNING
      VALUE(rv_node_type) TYPE zif_dt_ajson_types=>ty_node_type.
  ...
  METHODS set
    IMPORTING
      ...
      iv_node_type TYPE zif_dt_ajson_types=>ty_node_type OPTIONAL
    RETURNING
      VALUE(ri_json) TYPE REF TO zif_dt_ajson
    RAISING
      zcx_dt_ajson_error.
